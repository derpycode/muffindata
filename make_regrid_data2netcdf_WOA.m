function [] = make_regrid_data2netcdf_WOA(PDATA,PNAME,PLNAME,PUNITS,PNLON,PNLAT,PVERT)
% make_regrid_data2netcdf_WOA
%
%   ***********************************************************************
%   *** Regrid discrete data to WOA netCDF format, regular grid ***********
%   ***********************************************************************
%
%   make_regrid_data2netcdf_WOA(PDATA,PNAME,PLNAME,PUNITS,PNLON,PNLAT,PVERT)
%   (equal lat increment grid)
%   'make_regrid_data2netcdf_WOA.nc' and takes 7 arguments:
%
...
%
%   Example #1
%           make_regrid_data2netcdf_WOA('data_d30Si.dat','d30Si','observed water column silicon isotope value in units of per mil','1',360,180,'WOA');
%           will grid the d30Si data in file: 'data_d30Si.dat'
%           to a WOA-compatable grid (1 degree lon, lat)
%   Example #2
%           make_regrid_data2netcdf_WOA('dfe_data_mar2014.dat','DFe','Dissolved iron','nM',360,180,'');
...
str_data_filenameout = [str_data_filenamein '_WOA'];
%
% *** create grid ******************************************************* %
%
...
netcdf.putAtt(ncid,NC_GLOBAL,'comments','conversion of ascii format data by make_regrid_data2netcdf_WOA.m');
...
netcdf.putAtt(ncid,NC_GLOBAL,'MatlabSource','make_regrid_data2netcdf_WOA.m');
% define dimensions
